...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Ugn3v6xSpg', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '8889', 'dbname' => 'Shizen_data', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.1, 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setNamingStrategy(${($_ = isset($this->services['prestashop.database.naming_strategy']) ? $this->services['prestashop.database.naming_strategy'] : ($this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('db_'))) && false ?: '_'});
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_06619028296a831c79243f6112c6a7be7aa15931e9c0a7316ec6ed846d5285af');
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('db_');
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('hCGExzM8TGTJiqNeaTDUVdjIJTimxCBGSeWSjeuCOOpuRRJ7I3f5k8Y6'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('hCGExzM8TGTJiqNeaTDUVdjIJTimxCBGSeWSjeuCOOpuRRJ7I3f5k8Y6');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'secret' => 'hCGExzM8TGTJiqNeaTDUVdjIJTimxCBGSeWSjeuCOOpuRRJ7I3f5k8Y6',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2019-05-15',
            'locale' => 'fr-FR',
            'cookie_key' => 'cCxdtknwKeo2LNmdVm87DAuzvcENVep2B3rzKIujQ8o79Q3dtMa2cPnU',
            'cookie_iv' => '2EgOv6V7',
            'new_cookie_key' => 'def00000134cb6775a55be7fcf8dc901ef3c4dca6f655b78a5194dc8ccbec4975ba44b1bac4f53652dd78998237972fcb69e75e028b418cbc6610928fb72c49227b2f5d5',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => 'hCGExzM8TGTJiqNeaTDUVdjIJTimxCBGSeWSjeuCOOpuRRJ7I3f5k8Y6',
