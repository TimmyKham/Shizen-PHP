            ...
            'form' => array(
                ...
                'input'  => array(
                    array(
                        ...
                        'hint'  => $this->l('Prefilled to edit your commercial incoice (you can change while editing)', 'DhlBackend'),
                        'class' => 'col-lg-5',
                    ...
                    array(
                        ...
                        'hint'             => $this->l('Use PLT option for auhtorized countries (dynamically proposed while editing your label). You can send your commercial invoice by digital transfer via Prestashop. No need anylonger to edit, print & attach it to your shipping. ', 'DhlBackend'),
                        'name'             => 'DHL_ENABLE_PLT',
                        'is_bool'          => true,
                        'values'           => array(
                            array(
                    ...
                    array(
                        ...
                        'hint'             => $this->l('Upload your signature to print it automatically onto your commercial invoice.', 'DhlBackend'),
                        'name'             => 'file',
                        'id'               => 'signature_file',
                        'display_image'    => true,
                        'required'         => false,
